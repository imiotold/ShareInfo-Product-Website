    ...
    const cardData = [
        {
            ...
            description:
                'Our platform offers a comprehensive suite of features designed to efficiently track and analyze student information, ensuring a smooth and successful placement experience.'
        },
        {
            ...
            description:
                'Our Skill Enhancement Program equips students with the essential skills for campus. Through targeted skill development, mock interviews, and much more.'
        },
        {
            ...
            description:
                'Connect with top companies for campus placements. Our platform simplifies the process, making it easy to invite companies to your campus.'
        }
    ];
